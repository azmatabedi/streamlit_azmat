...
def transform(responses):
    ...
    #   except:
            print("key not found")
    result={'products':products,'issues':issues,'sub_products':sub_products,'compliant_ids':compliant_ids,'timely':timely,'company_response':company_respopnse,'submited_via':submitted_via,'company':comapnys,'date_recive':date_recive,'state':state,'sub_issue':sub_issue}
