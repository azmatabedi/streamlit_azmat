...
import pandas as pd
def task1_a():
    url = "https://gist.githubusercontent.com/mshafrir/2646763/raw/8b0dbb93521f5d6889502305335104218454c2bf"

    payload={}
    headers =  {'Content-Type': 'application/json'}

    list_of_state=json.loads(requests.request("GET", url, headers=headers, data=payload).text)
    size=500
    time_delta=365
